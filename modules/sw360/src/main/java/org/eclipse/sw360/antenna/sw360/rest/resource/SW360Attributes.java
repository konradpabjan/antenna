...
public class SW360Attributes {
    ...
    public static final String RELEASE_EXTERNAL_ID_DLICENSES = "declared_licenses";
    public static final String RELEASE_EXTERNAL_ID_OLICENSES = "observed_licenses";
    public static final String RELEASE_EXTERNAL_ID_OREPO = "orig_repo";
    public static final String RELEASE_EXTERNAL_ID_SWHREPO = "swh";
